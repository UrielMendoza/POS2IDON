...
if pre_start_flag == 1:
    ...
    for current_item in processing_items:
        ...
        if _search_by == "tile":
            ...
            # folder variables already set from User_Inputs import
            ...
            try:
                if service == "GC":
                    if _search_by == "tile":
                        ...
                        log_list_1 = CollectDownloadLinkofS2L1Cproducts_GC(current_roi, sensing_period, "configs", s2l1c_products_folder)
                    ...
                    if _search_by == "tile":
                        log_list_9 = collect_s2l1c_cdse_by_tile(current_tile, sensing_period, s2l1c_products_folder)
                    else:
                        log_list_9 = collect_s2l1c_cdse(current_roi, sensing_period, s2l1c_products_folder)
